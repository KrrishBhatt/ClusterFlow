...
export default function RegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (data.userId) {
        success(`Account created! Your ID: ${data.userId}`)
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        <div className="auth-card-header">
          ...
          <p className="auth-subtitle">Join the ClusterFlow network</p>
        </div>
      ...
      <style>{`
        ...
        .auth-brand { position:relative; z-index:1; font-weight:800; font-size:1.1rem; color:var(--green-bright); text-decoration:none; display:flex; align-items:center; gap:0.4rem; margin-bottom:2rem; letter-spacing:-0.02em; }
        .auth-brand-dot { width:7px; height:7px; background:var(--amber-bright); border-radius:50%; box-shadow:0 0 8px var(--amber-bright); display:inline-block; }
